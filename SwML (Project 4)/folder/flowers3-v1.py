...
csv_logger = CSVLogger('flowers-training-split3.log', separator=',', append=False)

checkpoint_filepath = 'best_model_split3.keras'
...
model.save('flowers-model-split3.keras')
